...
flowchart TD
    A[📥 Raw Data<br>2019_Q1_Cleaned + 2020_Q2_Cleaned] --> B[🗄️ BigQuery Dataset<br>Cyclistic]
    B --> C[🛠️ create_trips_clean.sql<br>Normalize + Merge Tables]
    C --> D[✔️ trips_clean Table<br>Cleaned, Unified Schema]
